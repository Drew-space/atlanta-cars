...
export default function Footer() {
  return (
    <footer className="bg-neutral-950 px-6 pt-6 pb-0">
      {/* CTA Banner */}
      <div className="max-w-5xl mx-auto rounded-2xl bg-[#04995b] overflow-hidden relative mb-14">
      ...
      <div className="max-w-5xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 pb-12">
        ...
        <div className="flex flex-col gap-4">
          <h4 className="text-neutral-500 text-xs font-semibold tracking-widest uppercase">
            Information
          </h4>
          ...
          <ul className="flex flex-col gap-4">
            <li className="flex items-start gap-3">
              <span className="w-8 h-8 rounded-full border border-neutral-700 flex items-center justify-center shrink-0">
                <Phone size={13} className="text-[#04995b]" />
              </span>
              <span className="text-neutral-300 text-sm leading-snug pt-1">
                +1-800-123-4567
              </span>
            </li>
            <li className="flex items-start gap-3">
              <span className="w-8 h-8 rounded-full border border-neutral-700 flex items-center justify-center shrink-0">
                <MapPin size={13} className="text-[#04995b]" />
              </span>
              <span className="text-neutral-300 text-sm leading-snug pt-1">
